...
add_shortcode("pdfjs-viewer", function ($incoming_from_post) {
    //set defaults
...
add_action('wp_enqueue_media', function () {
    wp_enqueue_script('media_button', plugins_url() . '/pdfjs-viewer-shortcode/pdfjs-media-button.js', ['jquery'], '1.0', true);
});
